...
function simulate_flow(unit_sources, Δslist, n̂, other_elements; tracer_start = collect(-3.0 .+ range(-3,3,length=31)*im), Trange = (0.0,20.0), dt=ILMPostProcessing.DEFAULT_DT,alg=ILMPostProcessing.DEFAULT_ADAPTIVE_ALG,kwargs...)
    ...
    traj = compute_trajectories((other_elements,sources),tracer_start,Trange,dt=dt,alg=alg,kwargs...)
